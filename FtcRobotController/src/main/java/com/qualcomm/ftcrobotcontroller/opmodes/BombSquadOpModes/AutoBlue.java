...
public class AutoBlue extends LinearOpMode {
    ...
    double targetHeadingB = 90;
    boolean autoCrash = false;
 ...
 */
        ...
        while (currentHeading < targetHeadingB && this.getRuntime() < 5.0) {
        ...
        if (currentHeading < targetHeadingB - 5) {
        ...
        this.resetStartTime();
        while (this.getRuntime() < 3.0 && !autoCrash) {
